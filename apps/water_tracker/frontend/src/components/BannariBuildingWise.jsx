...
const BannariBuildingWise = () => {
    ...
    const fetchData = useCallback(async () => {
        try {
            setLoading(true);
            const response = await api.get('reports/bannari-building-wise/', {
                params: { month, year }
            });
    ...
    const handleExportExcel = () => {
        ...
        exportToExcel(
            worksheetData,
            `Bannari_Building_Wise_${data.month_name}_${data.year}`,
            'Building Wise Purchase',
            `Building Wise Water Purchase from Bannari Water (${data.month_name} ${data.year})`,
        ...
        <div className="space-y-6">
            <div className="bg-white dark:bg-slate-800 p-4 rounded-lg shadow flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 border border-gray-200 dark:border-slate-700">
                <h2 className="text-xl font-bold text-gray-900 dark:text-slate-100">
                    Building Wise Water Purchase (Bannari Water)
                </h2>
            ...
            {loading ? (
                ...
                <>
                    <div id="bannari-summary" className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        ...
                        <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg border border-purple-100 dark:border-purple-800">
                            ...
                            <p className="text-2xl font-bold text-purple-900 dark:text-blue-100">{data.grand_total.total_liters.toLocaleString()} Ltrs</p>
                        </div>
                    ...
                    <div id="bannari-table" className="bg-white dark:bg-slate-800 rounded-lg shadow border border-gray-200 dark:border-slate-700 overflow-hidden">
...
export default BannariBuildingWise;
