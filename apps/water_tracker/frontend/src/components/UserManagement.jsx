...
const UserManagement = () => {
    ...
    const handleBackup = async () => {
        ...
        try {
            ...
            link.href = url;
            link.setAttribute('download', `water_tracker_db_${new Date().toISOString().split('T')[0]}.sqlite3`);
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="p-4 border border-blue-100 dark:border-blue-900/30 rounded-lg bg-blue-50/20 dark:bg-blue-900/10">
                                ...
                                <p className="text-sm text-gray-600 dark:text-slate-400 mb-4">
                                    Download a complete copy of the application database (`db.sqlite3`). It's recommended to do this regularly.
                                </p>
                                <button
                                ...
                                >
                                    {isBackingUp ? (
                                        ...
                                        <><svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" /></svg> Download SQLITE Backup</>
                                    )}
                                </button>
                            </div>
                            ...
                            <div className="p-4 border border-red-100 dark:border-red-900/30 rounded-lg bg-red-50/20 dark:bg-red-900/10">
                                ...
                                <p className="text-sm text-gray-600 dark:text-slate-400 mb-4">
                                    Upload a previously backed-up SQLITE file to restore the database. <span className="font-bold text-red-600 dark:text-red-400">Warning: This overrides all current data.</span>
                                </p>
                                <input
                                    type="file"
                                    ref={fileInputRef}
