...
const Dashboard = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 transition-colors duration-300">
            <h1 className="text-4xl font-extrabold text-blue-900 dark:text-white mb-8 border-b dark:border-gray-700 pb-4">Dashboard</h1>
            ...
            <div className="grid grid-cols-1 gap-8">
                ...
                {stats.monthly_matrix && stats.monthly_matrix.locations && stats.monthly_matrix.locations.length > 0 && (
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-blue-100 dark:border-gray-700 overflow-hidden">
                        <div className="p-6 border-b border-blue-50 dark:border-gray-700 flex justify-between items-center bg-blue-50/30 dark:bg-gray-900/50">
                            <h2 className="text-xl font-bold text-gray-800 dark:text-white flex items-center">
                                <span className="w-2 h-6 bg-orange-500 rounded-full mr-3"></span>
                                Daily Normal Water Purchase details - {stats.monthly_matrix.month_name} {stats.monthly_matrix.year} (KL)
                            </h2>
                                ...
                                <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-100 dark:divide-gray-700">
                                    {stats.monthly_matrix.locations.map((loc, idx) => (
                                        <tr key={idx} className="hover:bg-blue-50/30 dark:hover:bg-blue-900/10 transition-colors">
                                            ...
                                            <td className="px-4 py-3 whitespace-nowrap text-sm font-black text-center text-blue-700 dark:text-blue-400 bg-blue-50/80 dark:bg-blue-900/20 sticky right-0 z-10 backdrop-blur border-l border-blue-100 dark:border-blue-900/30">
                                                {loc.total.toFixed(1)}
                                            </td>
                                        </tr>
                                    ))}
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-blue-100 dark:border-gray-700 overflow-hidden">
                        <div className="p-6 border-b border-blue-50 dark:border-gray-700 flex justify-between items-center bg-blue-50/30 dark:bg-gray-900/50">
                            <h2 className="text-xl font-bold text-gray-800 dark:text-white flex items-center">
                                ...
                                Monthly Normal Water Purchase Details
                            </h2>
            ...
            <div className="mt-12 bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-blue-100 dark:border-gray-700 overflow-hidden">
                <div className="p-6 border-b border-blue-50 dark:border-gray-700 bg-blue-50/30 dark:bg-gray-900/50">
                    <h2 className="text-xl font-bold text-gray-800 dark:text-white flex items-center">
            ...
            <div className="grid grid-cols-1 gap-12 mt-12 pb-12">
                ...
                {stats.normal_water_breakdown && stats.normal_water_breakdown.length > 0 && (
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
                        <div className="p-6 border-b border-gray-50 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50">
                            <h2 className="text-xl font-bold text-gray-800 dark:text-white">Building Wise Water Purchase from Muthu nagar well using Rathinam vehicle Feb'2026</h2>
                        </div>
                        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead className="bg-gray-50 dark:bg-gray-900/50">
                                <tr>
                            ...
                            <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                                {stats.normal_water_breakdown.map((item, index) => (
                                    <tr key={index} className="hover:bg-gray-50 dark:hover:bg-gray-900/40 transition-colors">
                                        ...
                                        <td className="px-6 py-4 text-sm dark:text-gray-400 text-center">{item.count_12kl}</td>
                                        <td className="px-6 py-4 text-sm dark:text-gray-400 text-center">{item.count_6kl}</td>
                            ...
                            {stats.normal_water_breakdown_total && (
                                <tfoot className="bg-gray-50 dark:bg-gray-900/80 font-bold border-t-2 border-gray-200 dark:border-gray-700">
                                    <tr>
                                        <td className="px-6 py-4 text-sm text-gray-900 dark:text-white uppercase">Grand Total</td>
                                        <td className="px-6 py-4 text-sm text-gray-900 dark:text-white text-center">{stats.normal_water_breakdown_total.count_12kl}</td>
                                        <td className="px-6 py-4 text-sm text-gray-900 dark:text-white text-center">{stats.normal_water_breakdown_total.count_6kl}</td>
                                        <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">{stats.normal_water_breakdown_total.total_liters.toLocaleString()} L</td>
                                        <td className="px-6 py-4 text-sm text-green-700 dark:text-green-400 font-black">₹{stats.normal_water_breakdown_total.total_amount.toLocaleString()}</td>
                                    </tr>
                                </tfoot>
                            )}
                        </table>
                ...
                {/* Bannari Water Breakdown */}
                {stats.bannari_water_breakdown && stats.bannari_water_breakdown.length > 0 && (
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 overflow-hidden">
                        <div className="p-6 border-b border-gray-50 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50">
                            <h2 className="text-xl font-bold text-gray-800 dark:text-white">Building Wise Water Purchase from Bannari Water Feb'2026</h2>
                        </div>
                        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead className="bg-gray-50 dark:bg-gray-900/50">
                                <tr>
                            ...
                            <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
                                {stats.bannari_water_breakdown.map((item, index) => (
                                    <tr key={index} className="hover:bg-gray-50 dark:hover:bg-gray-900/40 transition-colors">
                                        <td className="px-6 py-4 text-sm font-semibold dark:text-gray-200">
                                            <Link
                                                to={`/entries?unloading_location=${item.location_id}&water_type=Normal Water (Salt)&loading_location__location_name__icontains=Bannari`}
                                                className="text-blue-600 dark:text-blue-400 hover:underline"
                                            >
                                                {item.location}
                                            </Link>
                            ...
                            {stats.bannari_water_breakdown_total && (
                                <tfoot className="bg-gray-50 dark:bg-gray-900/80 font-bold border-t-2 border-gray-200 dark:border-gray-700">
                                    <tr>
                                        <td className="px-6 py-4 text-sm text-gray-900 dark:text-white uppercase">Grand Total</td>
                                        <td className="px-6 py-4 text-sm text-gray-900 dark:text-white text-center">{stats.bannari_water_breakdown_total.count_12kl}</td>
                                        <td className="px-6 py-4 text-sm text-gray-900 dark:text-white text-center">{stats.bannari_water_breakdown_total.count_6kl}</td>
                                        <td className="px-6 py-4 text-sm text-gray-900 dark:text-white">{stats.bannari_water_breakdown_total.total_liters.toLocaleString()} L</td>
                                        <td className="px-6 py-4 text-sm text-green-700 dark:text-green-400 font-black">₹{stats.bannari_water_breakdown_total.total_amount.toLocaleString()}</td>
                                    </tr>
                                </tfoot>
                            )}
                        </table>
